...
class Director:
  ...
  def start_game(self):    
    # Displays the inital games graphics and starts the game by running the main game loop.
  ...
  def _setup_game(self):
    # Displays the starting game graphics in a private function

    # Args:
    # self (Director): An instance of Director.

    self._terminal.write_text("\n" + self._display.update_display(True))   
